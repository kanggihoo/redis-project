...
- `RestClient` (Recommended for Boot 4) or `RestTemplate` with mock server support
- Jackson ObjectMapper
- `MockRestServiceServer`

> [!TIP]
> **@RestClientTest vs RestTestClient**: 
> - Use **@RestClientTest** when your service calls **external** APIs (mocks the external server).
> - Use **RestTestClient** to test your own **Controller** endpoints (a more modern replacement for TestRestTemplate).
...
## Testing RestClient (Spring Boot 4 Standard)
